...
./build/RISCV/gem5.opt ./configs/example/se.py --cmd=./progs/mem_test --cpu-type=TimingSimpleCPU --mem-type=Ramulator --ramulator-config=../ramulator/configs/DDR4-config.cfg > debug_mem
